...
class StartEndDataset_subtitles(Dataset):
    ...
    def __init__(self, dset_name, data_path, v_feat_dirs, q_feat_dir, s_feat_dir=None,
        ...
        self.use_sub_tef = "sub_tef" in ctx_mode
...
def prepare_batch_inputs_subtitles(batched_model_inputs, device, non_blocking=False):
    model_inputs = dict(
