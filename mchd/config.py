...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        parser.add_argument("--dset_name", type=str, choices=["hl", 'tvsum','charadesSTA'])
        ...
        parser.add_argument("--t_feat_dirs", type=str, default=None,nargs="+",
                            help="text feature dirs. If more than one, will concat their features. "
                                 "Note that sub ctx features are also accepted here.")
        parser.add_argument("--t_feat_dir", type=str, default=None, help="text/query feature dir")
        ...
        parser.add_argument("--v_objectFeat_dim", default=2560,type=int, help="object video feature dim")
        ...
        # subtitles
        parser.add_argument("--s_feat_dir", type=str, help="subtitle feature dir")
        parser.add_argument("--s_feat_dirs", type=str, help="subtitle feature dir",nargs="+")
        parser.add_argument("--s_feat_dim", type=int, help="subtitles feature dim")
        parser.add_argument("--s_feat_type", type=str, help="subtitles feature type",default="clip")
        ...
        parser.add_argument('--new_loss_coef', default=1, type=float)
        self.parser = parser
    ...
    def parse(self, a_feat_dir=None):
        ...
        if isinstance(self, TestOptions):
            ...
            save_fns = ['./mchd/model.py',
                        './mchd/transformer.py',
                        './mchd/train.py',
                        './mchd/start_end_dataset_subtitles.py']
        ...
        opt.use_simple_tef = "simple_tef" in opt.ctx_mode
        opt.use_video = "video" in opt.ctx_mode
        opt.use_sub_tef = "tef____" in opt.ctx_mode
        ...
        if opt.use_tef:
            ...
            opt.v_feat_dim += 2
        # 加
        if opt.use_simple_tef:
            opt.v_objectFeat_dim += 12
        if opt.use_sub_tef:
            opt.s_feat_dim += 2
